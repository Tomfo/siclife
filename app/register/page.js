...
export default function Register() {
	...
	const data = useMemo(
		() => [
			...
			},
			{
				...
				role: 'Editor',
				avatar: 'https://placehold.co/40x40/3357FF/FFFFFF?text=PJ',
			},
			{
				id: 4,
				firstName: 'Alice',
				...
				role: 'User',
				avatar: 'https://placehold.co/40x40/FF33F5/FFFFFF?text=AB',
			},
			{
				id: 5,
				firstName: 'Bob',
				...
				role: 'Admin',
				avatar: 'https://placehold.co/40x40/57FF33/FFFFFF?text=BW',
			},
			{
				id: 6,
				firstName: 'Charlie',
				...
				role: 'User',
				avatar: 'https://placehold.co/40x40/F5FF33/FFFFFF?text=CG',
			},
			{
				id: 7,
				firstName: 'Diana',
				...
				role: 'Editor',
				avatar: 'https://placehold.co/40x40/33F5FF/FFFFFF?text=DB',
			},
			{
				id: 8,
				firstName: 'Eve',
				...
				role: 'User',
				avatar: 'https://placehold.co/40x40/FF338D/FFFFFF?text=EG',
			},
			{
				id: 9,
				firstName: 'Frank',
				...
				role: 'Admin',
				avatar: 'https://placehold.co/40x40/8D33FF/FFFFFF?text=FB',
			},
			{
				id: 10,
				firstName: 'Grace',
				...
				role: 'User',
				avatar: 'https://placehold.co/40x40/33FF8D/FFFFFF?text=GR',
			},
			{
				id: 11,
				firstName: 'Heidi',
				...
				role: 'Editor',
				avatar: 'https://placehold.co/40x40/FF8D33/FFFFFF?text=HY',
			},
			{
				id: 12,
				firstName: 'Ivan',
				...
				role: 'User',
				avatar: 'https://placehold.co/40x40/8DFF33/FFFFFF?text=IO',
			},
			{
				id: 13,
				firstName: 'Judy',
				...
				role: 'Admin',
				avatar: 'https://placehold.co/40x40/338DFF/FFFFFF?text=JP',
			},
			{
				id: 14,
				firstName: 'Kelly',
				...
				role: 'User',
				avatar: 'https://placehold.co/40x40/FF3333/FFFFFF?text=KP',
			},
			{
				id: 15,
				firstName: 'Liam',
				...
				role: 'Editor',
				avatar: 'https://placehold.co/40x40/33FF33/FFFFFF?text=LC',
			},
		],
		[]
	);
	...
	const columns = useMemo(
		() => [
			...
			{
				id: 'fullNameWithAvatar', // New ID for the combined column
				header: 'User',
				// Use accessorFn to provide a string for filtering that includes first name, last name, and email
				accessorFn: (row) => `${row.firstName} ${row.lastName} ${row.email}`,
				cell: ({ row }) => (
					<div className='flex items-center space-x-3 p-2 bg-white rounded-lg shadow-sm border border-gray-100 hover:bg-gray-50 transition duration-150 ease-in-out'>
						<img
							src={row.original.avatar}
							alt={`${row.original.firstName} ${row.original.lastName}'s avatar`}
							className='w-10 h-10 rounded-full object-cover border-2 border-blue-400'
							onError={(e) => {
								e.target.onerror = null;
								e.target.src =
									'https://placehold.co/40x40/CCCCCC/666666?text=N/A';
							}} // Fallback image
						/>
						<div>
			...
			// Removed individual firstName and lastName columns
			{
				accessorKey: 'role',
				header: 'Role',
				cell: (info) => info.getValue(),
